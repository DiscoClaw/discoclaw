...
- Before drafting, consult the `## Lessons` section of `docs/compound-lessons.md` to avoid rediscovering known patterns. When a plan reveals a new reusable lesson, include a `docs/compound-lessons.md` update in `## Changes`.
