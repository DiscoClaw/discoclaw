...
- Canonical sync modules: `src/tasks/task-sync-engine.ts`, `src/tasks/sync-coordinator.ts`, `src/tasks/thread-helpers.ts`, `src/tasks/thread-ops.ts`, `src/tasks/tag-map.ts`
