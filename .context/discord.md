...
- Compatibility shims: `src/beads/bead-sync.ts`, `src/beads/discord-sync.ts`, `src/beads/initialize.ts`, `src/beads/forum-guard.ts`, `src/beads/auto-tag.ts`, `src/beads/types.ts`, `src/beads/bd-cli.ts`
