/**
 * React to the last message in a named channel.
 * Usage: node scripts/react-last-message.mjs <channel-name> <emoji>
 */
...
if (!channelName || !emoji) {
  process.stderr.write('Usage: node scripts/react-last-message.mjs <channel-name> <emoji>\n');
  process.exit(1);
}
...
client.once('ready', async () => {
  ...
  try {
    ...
    process.stdout.write(`Reacted to message ${last.id} with ${emoji}\n`);
    client.destroy();
    process.exit(0);
  } catch (err) {
