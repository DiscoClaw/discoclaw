...
# store.update() call. TaskSyncWatcher subscribes to that event and triggers
...
log "on-update: events are handled in-process via TaskStore (src/tasks/sync-watcher.ts)"
